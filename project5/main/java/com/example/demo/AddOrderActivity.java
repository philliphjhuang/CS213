...
public class AddOrderActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener, CompoundButton.OnCheckedChangeListener, View.OnClickListener {
        ...
        builder.setMessage( R.string.tips_confirm_order)
                .setPositiveButton(R.string.confirm, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        pizzas.add(pizza);
                        Toast.makeText(AddOrderActivity.this, "Order successful!", Toast.LENGTH_SHORT).show();
                        dialog.cancel();
                    }
                })
